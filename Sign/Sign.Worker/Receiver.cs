    ...
    public class Receiver : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += (ch, ea) =>
            {
                ...
                var signModel = JsonConvert.DeserializeObject<SignModel>(content);

                HandleMessage(signModel);
        ...
        private void HandleMessage(SignModel signModel)
        {
            _signManager.UpdateSign(signModel);
        }
